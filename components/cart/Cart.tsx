                            ...
                            cart.map((product: Product) => (
                                ...
                                >
                                    <Image
                                        ...
                                        height={50} />
                                    <Text
                                        color='white'>{product.title}
                                    </Text>
                                    <Text
                                        color='white'>{currencyParser(product.price)}
                                    </Text>
                                    <Button
                                        onClick={() => deleteHandler(Number(product.id))}
                                        color='white'
                                        borderRadius='9999'
                                        marginLeft={3}
                                        colorScheme={'red'}
                                ...
                                <>
                                    ...
                                    >
                                        <Button
                                            ...
                                            color='white'
                                            fontWeight='bold'
                                            href={`https://wa.me/3546650023?text=${encodeURIComponent(text)}`}
